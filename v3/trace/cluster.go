// Package trace contains all the types provided for tracing within the radixxx
...
// analysis, etc...
//
// BIG LOUD DISCLAIMER DO NOT IGNORE THIS: while the main radixxx package is
...
// The methods in the main radixxx package which invoke trace types are guaranteed
// to remain stable.
package trace
...
type ClusterTrace struct {
	...
	// Redirected is called when radixxx.Do responded 'MOVED' or 'ASKED'.
