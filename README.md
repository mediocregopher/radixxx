...
[![Build Status](https://travis-ci.org/mediocregopher/radixxx.svg)](https://travis-ci.org/mediocregopher/radixxx)
![GitHub tag (latest SemVer)](https://img.shields.io/github/tag/mediocregopher/radixxx.svg)
[![GoDoc](https://godoc.org/github.com/mediocregopher/radixxx?status.svg)][godoc]
[![Go Report Card](https://goreportcard.com/badge/github.com/mediocregopher/radixxx/v3)](https://goreportcard.com/report/github.com/mediocregopher/radixxx/v3)
...
but can be found [here](https://github.com/mediocregopher/radixxx.v2).

**This project's name was recently changed from `radixxx.v3` to `radixxx`, to
...
[Module][module]-aware mode:
    ...
    go get github.com/mediocregopher/radixxx/v3
    // import github.com/mediocregopher/radixxx/v3

Legacy GOPATH mode:

    go get github.com/mediocregopher/radixxx
    // import github.com/mediocregopher/radixxx

## Testing

    # requires a redis server running on 127.0.0.1:6379
    go test github.com/mediocregopher/radixxx/v3
...
[redispipe][redispipe] project and @funny-falcon, radixxx/v3 is significantly
...
Some of radixxx's results are not included below because they use a non-default
configuration.

[bench_thread]: https://github.com/mediocregopher/radixxx/issues/67#issuecomment-465060960


```
# go get rsc.io/benchstat
# cd bench
# go test -v -run=XXX -bench=ParallelGetSet -cpu 32 -cpu 64 -benchmem . >/tmp/radixxx.stat
# benchstat radixxx.stat
name                                   time/op
ParallelGetSet/radixxx/default-32        2.15µs ± 0% <--- The good stuff
ParallelGetSet/radixxx/default-64        2.05µs ± 0% <--- The better stuff
...
name                                   alloc/op
ParallelGetSet/radixxx/default-32         72.0B ± 0%
ParallelGetSet/radixxx/default-64         84.0B ± 0%
...
name                                   allocs/op
ParallelGetSet/radixxx/default-32          4.00 ± 0%
ParallelGetSet/radixxx/default-64          4.00 ± 0%
...
[redis]: http://redis.io
[godoc]: https://godoc.org/github.com/mediocregopher/radixxx
